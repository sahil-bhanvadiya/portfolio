...
export default function Button({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none flex-none h-auto relative w-auto whitespace-pre opacity-70 shrink-0 flex-col justify-start flex group-hover:opacity-100">
